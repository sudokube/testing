...
def undistort(img, cal_dir='C:/Users/LaByeol/Desktop/dauto/modules/lane/camera_cal/cal_pickle.p'):
...
myclip = VideoFileClip(f'{sys.argv[1]}')#.subclip(40,43)
output_vid = f'{sys.argv[1][:-4] + "P4.mp4"}'
